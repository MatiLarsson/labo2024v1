...
# Este script hace: 100 iteraciones inteligentes bayesianas para encontrar los mejores
# hiperparametros de un modelo ranger con 5 fold cross validation para cada set de 
# hiperparamentros candidatos (se promedian las ganancias de cada 5 fold) y se loguea.
# mlrMBO es el paquete que realiza la optimizacion bayesiana. Juega con los hiperparametros:
# num.trees, max.depth, min.node.size, mtry
# El algoritmo ranger se correra un total de 100 veces, con 5 fold cross validation = 500 corridas
