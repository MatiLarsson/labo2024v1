...
PARAM <- list()
PARAM$experimento <- "KA4540-BEST-COMPLEMENTARIA"
...
PARAM$finalmodel$num_iterations <- 649
PARAM$finalmodel$learning_rate <- 0.0192303175571853
PARAM$finalmodel$feature_fraction <- 0.745923341576339
PARAM$finalmodel$min_data_in_leaf <- 398
PARAM$finalmodel$num_leaves <- 785
PARAM$finalmodel$lambda_l1 <- 0
PARAM$finalmodel$lambda_l2 <-477
