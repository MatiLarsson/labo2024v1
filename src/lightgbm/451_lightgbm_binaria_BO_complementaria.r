...
# Este script realiza 120 iteraciones de optimizacion bayesiana inteligentes.
# En cada iteracion juega con los hiperparametros de lightgbm
# entre ellos: learning_rate, feature_fraction, min_data_in_leaf, num_leaves e incluso la cantidad de envios
# Realiza en cada iteracion -> 5-fold cross validation. Para cada fold entrena un LightGBM con los hiperparametros
# y calcula la ganancia de la prediccion. La ganancia de la iteracion es el promedio las ganancias de los envios.
...
PARAM$experimento <- "HT4510_complementaria"
...
hs <- makeParamSet(
  ...
  makeIntegerParam("max_bin", lower = 29L, upper = 33L)
)
