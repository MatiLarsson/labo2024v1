...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008)
...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    min_gain_to_split = c(0.0, 5.0), # min_gain_to_split >= 0.0
    min_sum_hessian_in_leaf = c(0.001, 5.0), #  min_sum_hessian_in_leaf >= 0.0
