...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/z551_TS_training_strategy_guantesnegros.r"


  param_local$future <- c(202109) # prediccion del futuro
  param_local$final_train <- c(202107, 202106, 202105) # train final con HP optimos


  param_local$train$training <- c(202105, 202104, 202103) # train para validar HP
  param_local$train$validation <- c(202106) # validacion de HP
  param_local$train$testing <- c(202107) # test
