...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$train$training <- c(202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009)
  param_local$train$validation <- c(202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009)
